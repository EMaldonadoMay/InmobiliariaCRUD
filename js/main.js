...
<a class="navbar-brand" href="index.html">
	<img src="./img/logo.svg" width="70rem" height="70rem" alt="Urban"/>
</a>
<span style="font-size: 1rem; font-weight: bold; line-height: 1rem;">Urban</span>
  ...
  <ul class="navbar-nav me-auto mt-2 mt-lg-0">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownId">
        <a class="dropdown-item" href="inmuebles.html">INMUEBLES</a>
        <a class="dropdown-item" href="#">Barrios</a>
      </div>
    </li>
  </ul>
